...
print( "Monte Carlo solution for : ", mc_integrate(func1, -2, 2, 2, 1000000))
print("Analytical solution:", 117.333)

print("For f(x)= 10 - x1\u00b2 - x2\u00b2 - x3\u00b2, integrated from -2 to 2 (for all x's)")
print("Monte Carlo solution: ", mc_integrate(func1, -2, 2, 3, 1000000))
print("Analytical solution: ", 384.000)

...
cfg = {'id':'ada','title':'Advanced Data Analytics','tagline':'Machine learning for economics and finance — from regression to reinforcement learning.',
 ...
 'schedule_note':'Each Monday has two meetings: the lecture at 12:30 and the exercise session at 16:30. Dates are the provisional 2026 calendar; materials are the current course corpus and may be updated week by week.',
 'facts':[{'h':'Meets','p':'Mondays, from 14 September','note':'Lecture 12:30–14:00 · exercise session 16:30–18:00 · rooms confirmed before the first session'},
 ...
 'team':[{'name':'Dimitrios Karyampas','role':'Lecturer','email':'dimitrios.karyampas@unil.ch',
          'note':'Lectures, and the project.'},
         {'name':'Anna Smirnova','role':'Teaching assistant','email':'anna.smirnova@unil.ch',
          'note':'Practice sessions, materials, and project sign-off.'}],
 'team_note':'Project proposals and questions about the requirements go to the teaching assistants.',

...
cfg = {'id':'ada','title':'Advanced Data Analytics','tagline':'Machine learning for economics and finance — from regression to reinforcement learning.',
 ...
 'facts':[{'h':'Meets','p':'Mondays, from 14 September','note':'[TIME] · [ROOM] · 2026 dates provisional'},
 ...
 'team':[{'name':'[LECTURER]','role':'Lecturer','email':'','note':'Lectures and the project.'},
         ...
         {'name':'[TA 2]','role':'Teaching assistant','email':''}],
